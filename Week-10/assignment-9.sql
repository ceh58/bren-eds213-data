/courses/EDS213/big-fat.sqlite3
...
SELECT name FROM sqlite_master WHERE type='index' AND tbl_name='Bird_nests';
...
SELECT Nest_ID FROM Bird_nests 
WHERE Site = 'nome' 
AND Species = 'ruff' 
AND Year = 1983 
AND Observer = 'cbishop' AND ageMethod = 'float';
...
SELECT COUNT(*) FROM (
    ...
    AND Species = 'ruff' 
    AND Year = 1983 
    AND Observer = 'cbishop' AND ageMethod = 'float') AS a;
